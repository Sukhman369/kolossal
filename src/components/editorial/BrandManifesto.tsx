...
export default function BrandManifesto() {
  return (
    <section id="manifesto" className="py-16 sm:py-24 md:py-32 border-y border-neutral-200/80 bg-white text-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 space-y-12 sm:space-y-20">
        {/* Editorial Heading */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-start">
          <div className="lg:col-span-4">
            <span className="text-[10px] sm:text-[11px] font-mono tracking-[0.25em] sm:tracking-[0.3em] text-[#580D1A] uppercase font-semibold block mb-2 sm:mb-3">
              THE BRAND MANIFESTO
            </span>
          ...
          <div className="lg:col-span-8 space-y-4 sm:space-y-6 text-neutral-600 font-light text-sm sm:text-base md:text-lg leading-relaxed">
            <p>
            ...
            <p className="text-xs sm:text-sm text-[#580D1A] font-mono tracking-wide font-medium">
        ...
        {/* 3 Pillars Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 pt-6 sm:pt-8 border-t border-neutral-200/80">
          <div className="space-y-3 p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-[#FAF9F7] border border-neutral-200/80 hover:border-[#580D1A]/40 transition-colors shadow-xs">
